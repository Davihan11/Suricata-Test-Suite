...
usage(){
  ...
  echo "-pps  | --trex-pps [PPS] to set packets per second for the stl.exact TRex mode. Default: 200000"
  echo "-tp   | --trex-total-packets [COUNT] to set total packets to send for the stl.exact TRex mode. Default: 10000000"
